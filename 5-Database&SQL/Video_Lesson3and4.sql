 ...
 *************************/
 ...
 /* If the tbl_species exists from the system, drop all the tables */
...
/* Creating the species table, which uses and ties everything together with the Foreign Key™ */
...
/******************************************************************
 ** How to do select statements with the joins from other tables **
 ******************************************************************/
SELECT * FROM tbl_species;
SELECT * FROM tbl_species WHERE species_name = 'chicken';


SELECT species_care FROM tbl_species;
SELECT care_type FROM tbl_care;

SELECT 
	tbl_care.care_type 
	FROM tbl_species 
	JOIN tbl_care ON tbl_care.care_id = tbl_species.species_care 
...
/* the inner join select without all the aliases */
SELECT
	tbl_species.species_name AS 'Species Name:', 
	tbl_animalia.animalia_type,
	tbl_class.class_type, 
	tbl_order.order_type, 
	tbl_habitat.habitat_type,
	tbl_nutrition.nutrition_type, 
	tbl_care.care_type
	FROM tbl_species
	INNER JOIN tbl_animalia ON tbl_animalia.animalia_id = tbl_species.species_animalia
	INNER JOIN tbl_class ON tbl_class.class_id = tbl_species.species_class
	INNER JOIN tbl_order ON tbl_order.order_id = tbl_species.species_order 
	INNER JOIN tbl_habitat ON tbl_habitat.habitat_id = tbl_species.species_habitat
