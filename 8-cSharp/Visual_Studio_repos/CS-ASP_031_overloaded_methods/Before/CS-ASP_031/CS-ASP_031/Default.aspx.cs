    ...
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (heroHealth > 0 && monsterHealth > 0)
            {
                ...
                displayMonsterStats("Hero", heroHealth);
                displayMonsterStats("Monster", monsterHealth);
            }
        ...
        /***************************************************************
         * Three seperate methods for doing almost the exact same thing
         * but give them the same name, so with different arguments for
         * each you have one overloaded method
         * *************************************************************/
