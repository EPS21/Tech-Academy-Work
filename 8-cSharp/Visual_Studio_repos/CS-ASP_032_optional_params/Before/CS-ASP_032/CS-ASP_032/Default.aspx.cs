    ...
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (heroHealth > 0 && monsterHealth > 0)
            {
                ...
                // To have optional parameters, you must put in all required ones first
                // EXCEPT if you call it explicitly like with defenderArmorBonus like here
